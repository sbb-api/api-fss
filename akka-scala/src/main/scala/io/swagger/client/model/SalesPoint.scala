...
case class SalesPoint (
  companyCode: Double,
  /* According to the logic in ZVS each distributionChannel has to have a identification number */
  channelNumber: Double,
  idWithControlNumber: String,
  idWithoutControlNumber: String
) extends ApiModel

...
case class CouponReference (
  /* This is the Id of the used promotion/campagne in the leading coupon-system of the SBB - today: Payseriennummer */
  couponId: String,
  /* This is the Promotion Code entered by the customer or printed on the coupon */
